...
import { User, Lock, Mail, Building, Save, Eye, EyeOff, CheckCircle, AlertCircle, Phone, MapPin } from 'lucide-react';
...
const Settings = () => {
  ...
  const handleProfileUpdate = async (e) => {
    ...
    try {
      ...
      await api.put('/institution/profile', updateData);
  ...
  const handlePasswordChange = async (e) => {
    ...
    try {
      await api.put('/institution/change-password', {
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="bg-white rounded-lg shadow-sm border border-gray-200">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-gray-600 mt-1">Manage your institution account settings and preferences</p>
        </div>
            ...
            <form onSubmit={handleProfileUpdate} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <p className="text-xs text-gray-500 mt-1">Institution name cannot be changed</p>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-500 font-mono"
                      disabled
                    />
                  </div>
                  <p className="text-xs text-gray-500 mt-1">Your unique institution access code</p>
                </div>
