...
module.exports = (sequelize, DataTypes) => {
  const Student = sequelize.define('Student', {
    ...
    yearOfEntry: { type: DataTypes.INTEGER, allowNull: false },
    yearOfGraduation: { type: DataTypes.INTEGER, allowNull: false },
    classOfDegree: { type: DataTypes.STRING, allowNull: false },
    certificateType: {
      type: DataTypes.ENUM(
